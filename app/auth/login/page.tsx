          ...
          <form className="space-y-6" onSubmit={handleLogin}>
            ...
            <div>
              <button
                ...
                disabled={loading}
                className="w-full bg-white text-slate-900 py-3 px-4 rounded-lg font-medium hover:bg-slate-100 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-slate-900 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center justify-center gap-2"
              >
