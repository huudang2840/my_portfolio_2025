  ...
  return (
    <div className="space-y-16">
      <header className="text-center space-y-6 animate-fade-in">
        <h1 className="font-display text-5xl md:text-6xl font-bold text-primary">All Projects</h1>
      ...
      <div className="text-center py-16">
        <div className="cta-card rounded-3xl p-8 md:p-12 max-w-2xl mx-auto">
          ...
          <a
            ...
            className="bg-gradient-to-r from-accent-500 to-ocean-500 text-white px-8 py-4 rounded-full font-medium hover:shadow-glow-sky transition-all duration-300 hover-lift inline-block"
          >
